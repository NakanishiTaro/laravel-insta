    ...
    <div class="row justify-content-center">
      <div class="col-8">
         <form action="{{route('profile.update')}}" method="post" class="bg-white shadow rounded-3 p-5" enctype="multipart/form-data"> 
            ...
            @method('PATCH')
            {{-- Route::patch --}}
            <h2 class="h3 mb-3 fw-bold text-muted">Update Profile</h2>
            <div class="row mb-3">
               <div class="col-4">
                  @if($user->avatar)
               ...
               <div class="col-auto align-self-end">
                  ...
                  <div id="avatar-info" class="form-text">
                     Acceptable formats: jeeg, jeg, png, gif, only <br>
            ...
            <div class="mb-3">
               ...
               <textarea name="introduction" id="introduction" rows="5" class="form-control" placeholder="Describe yourseil">{{old('introduction', $user->introduction)}}</textarea>
               {{-- error --}}
               @error('introduction')
                     <p class="text-danger small">{{$message}}</p>
               @enderror
